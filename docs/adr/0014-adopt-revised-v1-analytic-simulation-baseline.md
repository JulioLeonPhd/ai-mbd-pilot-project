...
vectors while preserving phase derived from the 3 GHz carrier.
...
least three complete guarded coverage PRFs throughout 6.8–100 km, with a
minimum native unambiguous speed of 42.4703 m/s. The analytic schedule retains
