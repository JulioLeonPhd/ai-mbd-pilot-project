...
| <a id="RAD-V1-020"></a>RAD-V1-020 | Clustering adjacency, merge, and report behavior is defined in the WP4 contract and verified by executable WP4/WP7 tests. | accepted, executable verification pending | ADR 0018 and WP4 manifest |
