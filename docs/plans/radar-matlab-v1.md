...
| WP4 — DSP architecture | D11–16 | G1; parallel with WP3 | Stage order, dimensions/rates, fixture seams, ambiguity-selection criteria, and diagrams. WP4 selects and verifies `[22,25,28,32,35]` usable pulses under the 70.653 ms cell-time cap at G2; downstream WP6e may reject the schedule and reopen G2. **G2, with WP3:** independent review finds no unresolved errors or contract conflicts. |
...
| WP6d — Receive angle processing | D17–26 | G2; parallel with WP6a–c | Synthetic 16×4 data gives correct commanded-look summation (16 azimuth elements per elevation row), four-stream dimensions, boresight, and specified elevation signs. Sub-beam azimuth estimation is out of V1. |
